				...
				$html .= '
					...
					<html>
						...
						<table class="tg" >
						  <tr>
							<th colspan="5">
								<img src="50mmbanner.jpg"> 
							</th>
						  </tr>
						
						  
						  <tr class="trhw">
							<td class="tg-vi9z" colspan="3">To.: '.$cnm.' <br></td>
							<td class="tg-vi9z" colspan="2">'.$sdate.'</td>
						  </tr>
						  <tr class="trhw">
							<td class="tg-vi9z" colspan="3">Order Name:'.$enm.'</td>
							<td class="tg-vi9z" colspan="2">Quataion No.:'.$data[$i]['fp_no'].'<br></td>
						  </tr>
						  <tr class="trhw">
							<td class="tg-vi9z" colspan="5">Order Date :'.$fdate.' <br></td>
						  </tr>
						  <tr class="trhw">
							<td class="tg-vi9z" colspan="3">Vennue.:';
						...
						$html .= '
						  ...
						  <tr class="trhw">
							<td class="tg-vi9z" colspan="5">Client.:'.$cmp.'</td>
						  </tr>	  
						  <tr class="trhw">
