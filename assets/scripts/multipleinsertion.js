...
$(document).on('click','#add',function()
	...
	function addnewdiv()
	{
		...
		'			</div>'+
		'		<input class="venuetxt m-wrap" id="hdn['+i+'][txtfunction]" name="hdn['+i+'][txtfunction]" type="text" />'+
		'		</div>'+
		'		<div class="pull-left margin-right-10">'+
		'			<div class="input-icon input-append">'+
		...
		'				<input data-format="dd-MM-yyyy HH:mm PP" class="fdate1" value="" type="text" name="hdn['+i+'][txtfromdate]" id="hdn['+i+'][txtfromdate]"></input>'+
		'				<span class="add-on">'+
		...
		'			<input data-format="dd-MM-yyyy HH:mm PP" type="text" class="fdate1" value="" name="hdn['+i+'][txttodate]" id="hdn['+i+'][txttodate]"></input>'+
		'			<span class="add-on">'+
		'			  <i class="icon-time" class="icon-calendar"></i>'+
		'			</span>'+
		'		</div>'+
