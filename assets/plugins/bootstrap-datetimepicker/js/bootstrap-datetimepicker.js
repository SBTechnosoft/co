 ...
 * Improvements by mylookas(just navigation icons modified)
...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="icon-angle-left"/></th>'+ //icon modifed by mylookas.
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="icon-angle-right"/></th>'+//icon modifed by mylookas.
							'</tr>'+
						'</thead>',
