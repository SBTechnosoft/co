<?php
	...
	{	
		...
		insCatgNew($conn,$_POST['txtcatgnm'],$_POST['txtcatgdes'],$cur_date);	
	}		
	
	if(isset($_POST['show']))
	{	
		$data = showCatgNew ($conn);
	...
	{	
		...
		delCatgNew($conn,$_POST['id'],$del_date);	
	}
	...
	{	
		...
		if($_POST['catname']!='')
		{
			$s2 = " `cat_name` like '%".trim($_POST['catname'])."%' ";
		}
