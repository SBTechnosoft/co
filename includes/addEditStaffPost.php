<?php
	...
	{	 
		$q = mysql_query("select `emp_id`,`first_name`,`last_name`,`email`,`mobile`,`relative1`,`relative2`, `password` as 'pass',`add1`,`add2`,`city`,`state`,`zip`,`staff_type` from  `staff_mst` where `staff_id` = '".$_POST['stfid']."' ");
