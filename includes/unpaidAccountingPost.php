<?php
			...
			<?php
				if($i == ($showClUnpaidCnt-1))
				{
					...
					<tr>
						...
						<td><?php echo $ClUnpaid[$i]['client_discount_amt'];?></td>
						<td><?php echo $ClUnpaid[$i]['service_tax_amt'];?></td>
						<td><?php echo $ClUnpaid[$i]['total_amt'];?></td>
						<td><?php echo $ClUnpaid[$i]['client_paid_amt'];?></td>				
						<td style="color:red;"><?php echo $ClUnpaid[$i]['remain_amt'] ;?></td>
						<td>					
	...
	if(isset($_POST['showClientUnpaidAmtType']))
	{	
		if($_POST['value']=='All')
		{
			$ClUnpaid = showClientUnpaidAmt ($conn);
		...
		{
			$ClUnpaid = showClientUnpaidAmtType ($conn,$_POST['value']);
		}
	...
	if(isset($_POST['showClientUnpaidAmtCmpType']))
	{	
		if($_POST['value']=='')
		{
			$ClUnpaid = showClientUnpaidAmt ($conn);
		...
		{
			$ClUnpaid = showClientUnpaidAmtCmpType ($conn,$_POST['value']);
		}
